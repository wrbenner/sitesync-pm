...
1. **Run `npm run typecheck` after every batch of changes.** The bash sandbox in our cowork sessions has a 45-second window — full tsc cold-start exceeds it. You have a longer window; use it. Do not ship code that hasn't been typechecked.
