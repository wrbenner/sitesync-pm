...
const OUT_DIR = path.resolve(__dirname, '..', 'polish-review', 'pages', 'closeout')
...
for (const vp of VIEWPORTS) {
  test.describe(`Closeout E2E @ ${vp.name}`, () => {
    ...
    test('closeout workflow', async ({ page }) => {
      ...
      await page.goto('#/closeout', { waitUntil: 'domcontentloaded' })
