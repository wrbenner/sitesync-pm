...
-- Photo URLs use Unsplash CDN with fixed photo ids + tight crop params so the
-- 64×64 thumbs in the cockpit always render a recognizable construction subject.
-- Public, no auth, no expiration, royalty-free for app use. If a network blocks
-- Unsplash specifically, the rendering layer falls back to a solid placeholder.
INSERT INTO field_captures (project_id, type, content, file_url, location, ai_category, ai_tags, linked_drawing_id, created_by, created_at) VALUES
  (project_id, 'photo', 'Level 14 slab pour in progress, concrete pump positioned on east side',                     'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=640&q=80&fm=jpg&auto=format&fit=crop', 'Level 14, East Core',    'concrete',     '["pour", "slab", "level_14", "concrete_pump"]',         NULL,   user_james,    '2026-03-18 09:30:00'),
  (project_id, 'photo', 'Steel erection Level 15, braced frame at grid B4 through B6',                               'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?w=640&q=80&fm=jpg&auto=format&fit=crop', 'Level 15, Grid B',       'structural',   '["steel", "erection", "braced_frame", "level_15"]',     dwg_02, user_david,    '2026-03-23 14:00:00'),
  (project_id, 'photo', 'Curtain wall installation south elevation Level 9, panels aligned and sealed',             'https://images.unsplash.com/photo-1521791136064-7986c2920216?w=640&q=80&fm=jpg&auto=format&fit=crop', 'South Elevation Level 9','exterior',     '["curtain_wall", "glazing", "south_elevation"]',        NULL,   user_david,    '2026-03-25 11:00:00'),
  ...
  (project_id, 'photo', 'Fire caulk missing at rated wall penetration, Level 9 mechanical room',                     'https://images.unsplash.com/photo-1581094288338-2314dddb7ece?w=640&q=80&fm=jpg&auto=format&fit=crop', 'Level 9, Mech Room',     'deficiency',   '["fire_caulk", "penetration", "deficiency", "level_9"]',NULL,   user_jennifer, '2026-03-20 08:15:00'),
  ...
  (project_id, 'photo', 'Lobby stone veneer first panels installed at north feature wall',                            'https://images.unsplash.com/photo-1503387837-b154d5074bd2?w=640&q=80&fm=jpg&auto=format&fit=crop', 'Level 1, North Lobby',   'finishes',     '["stone", "lobby", "feature_wall", "finishes"]',        dwg_09, user_jennifer, '2026-03-27 10:30:00'),
  ...
  (project_id, 'photo', 'Cracked floor tile at main building entrance, marked for replacement',                      'https://images.unsplash.com/photo-1580674684081-7617fbf3d745?w=640&q=80&fm=jpg&auto=format&fit=crop', 'Level 1, Main Entrance', 'deficiency',   '["tile", "crack", "lobby", "deficiency"]',               NULL,   user_karen,    '2026-03-23 09:00:00'),
