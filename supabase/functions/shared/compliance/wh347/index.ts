// DO NOT EDIT IN PLACE — duplicated from src/lib/compliance/wh347/index.ts
...
import { pickWageDecision, computeWeekGross, detectRateViolation,
         type PrevailingWageDecisionRow, type WageLookupQuery } from '../prevailingWage/index.ts'
import type {
