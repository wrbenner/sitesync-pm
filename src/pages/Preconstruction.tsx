...
type BidAnalysis = {
  bids: PreconBidSubmission[]; avg: number; median: number;
  lowest: PreconBidSubmission; highest: PreconBidSubmission;
  spread: number; variancePct: number; stdDev: number; coeffVar: number;
  unusuallyLow: PreconBidSubmission[]; unusuallyHigh: PreconBidSubmission[];
                ...
                <>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing['3'] }}>
                    <div style={{ fontSize: typography.fontSize.caption, color: colors.textTertiary }}>
                      ...
                      {aiAnalysis && ` · Avg: ${fmt(aiAnalysis.avg)}`}
                    </div>
