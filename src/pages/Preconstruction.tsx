...
type AiBidInsight = { type: 'warning' | 'info' | 'success'; text: string }
type AiBidAnalysis = {
  avg: number; median: number; spread: number; variancePct: number
  stdDev: number; coeffVar: number; insights: AiBidInsight[]
  bids: unknown[]; lowest: unknown; highest: unknown
  unusuallyLow: unknown[]; unusuallyHigh: unknown[]
}
