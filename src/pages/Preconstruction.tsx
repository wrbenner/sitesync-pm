      ...
      {selectedPackage && (
        <Card padding={spacing['4']}>
          ...
          {detailTab === 'overview' && (
            <div>
              {/* AI Analysis */}
              {aiAnalysis && (aiAnalysis as any).insights && ( // type-safe-ok — AI response shape is dynamic, not typed
                ...
                <>
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: spacing['3'] }}>
                    <div style={{ fontSize: typography.fontSize.caption, color: colors.textTertiary }}>
                      ...
                      {aiAnalysis && ` · Avg: ${fmt((aiAnalysis as any).avg || 0)}`} {/* type-safe-ok — AI response */}
                    </div>
