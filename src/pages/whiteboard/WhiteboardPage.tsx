...
export const WhiteboardPage: React.FC = () => {
  ...
  // whiteboardKey doubles as a remount trigger — bumping it forces
  // React to drop the inner Whiteboard's state. State, not ref, because
  // the value is read during render to position on the JSX `key` prop.
