...
export const Workforce: React.FC = () => {
  ...
  const totalRegularHrs = timeEntries?.reduce((s, e) => s + ((e.regular_hours as number) || 0), 0) || 0
  const totalOTHrs = timeEntries?.reduce((s, e) => s + ((e.overtime_hours as number) || 0), 0) || 0
  ...
  members?.forEach((m) => {
    const trade = (m.trade as string) || 'Unassigned'
