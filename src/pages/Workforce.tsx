...
export const Workforce: React.FC = () => {
  ...
  const totalRegularHrs = timeEntries?.reduce((s, e) => s + ((e as Record<string, number>).regular_hours || 0), 0) || 0
  const totalOTHrs = timeEntries?.reduce((s, e) => s + ((e as Record<string, number>).overtime_hours || 0), 0) || 0
