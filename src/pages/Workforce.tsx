...
type WorkforceMemberRow = Database['public']['Tables']['workforce_members']['Row']
...
export const Workforce: React.FC = () => {
  ...
  const totalRegularHrs = timeEntries?.reduce((s, e) => s + ((e as { regular_hours?: number }).regular_hours || 0), 0) || 0
  const totalOTHrs = timeEntries?.reduce((s, e) => s + ((e as { overtime_hours?: number }).overtime_hours || 0), 0) || 0
