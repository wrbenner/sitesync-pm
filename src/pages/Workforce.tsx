...
export const Workforce: React.FC = () => {
  ...
  const totalRegularHrs = timeEntries?.reduce((s: number, e: Record<string, unknown>) => s + ((e.regular_hours as number) || 0), 0) || 0
  const totalOTHrs = timeEntries?.reduce((s: number, e: Record<string, unknown>) => s + ((e.overtime_hours as number) || 0), 0) || 0
