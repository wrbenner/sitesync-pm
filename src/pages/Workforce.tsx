...
export const Workforce: React.FC = () => {
  ...
  const totalRegularHrs = timeEntries?.reduce((s: number, e) => s + (((e as Record<string, unknown>).regular_hours as number) || 0), 0) || 0
  const totalOTHrs = timeEntries?.reduce((s: number, e) => s + (((e as Record<string, unknown>).overtime_hours as number) || 0), 0) || 0
