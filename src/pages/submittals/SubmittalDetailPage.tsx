...
export function SubmittalDetailPage() {
  ...
  useEffect(() => {
    ...
    const attachments = ((submittal as Record<string, unknown>).attachments as unknown[] | null) ?? []
  ...
  const handleDocumentUpload = useCallback(async (file: File) => {
    ...
    const currentAttachments = ((submittal as Record<string, unknown>).attachments as unknown[] | null) ?? []
    const newAttachment = {
      path: storagePath,
      name: file.name,
      size: file.size,
