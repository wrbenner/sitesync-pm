...
export function SubmittalDetailPage() {
  ...
  useEffect(() => {
    ...
    const attachments = ((submittal as { attachments?: unknown[] }).attachments || []) as unknown[]
  ...
  const handleDocumentUpload = useCallback(async (file: File) => {
    ...
    const currentAttachments = ((submittal as { attachments?: unknown[] }).attachments || []) as unknown[]
    const newAttachment = {
      path: storagePath,
      name: file.name,
      size: file.size,
