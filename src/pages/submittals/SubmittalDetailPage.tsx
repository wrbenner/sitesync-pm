...
export function SubmittalDetailPage() {
  ...
  useEffect(() => {
    ...
    const attachments = ((submittal as any).attachments || []) as unknown[] // type-safe-ok — attachments is a JSONB field not in generated types
  ...
  const handleDocumentUpload = useCallback(async (file: File) => {
    ...
    const currentAttachments = ((submittal as any).attachments || []) as unknown[] // type-safe-ok — attachments is a JSONB field not in generated types
    const newAttachment = {
      path: storagePath,
      name: file.name,
      size: file.size,
