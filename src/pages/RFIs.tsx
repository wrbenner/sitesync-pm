...
const extraRfis = [
  { id: 6, rfiNumber: 'RFI-006', title: 'Elevator pit waterproofing detail', from: 'Turner Construction', to: 'Structural Engineer', priority: 'high', status: 'pending', dueDate: '2025-04-02', submitDate: '2025-03-22' },
  { id: 7, rfiNumber: 'RFI-007', title: 'Roof drain location and sizing', from: 'HVAC Subcontractor', to: 'MEP Consultant', priority: 'medium', status: 'approved', dueDate: '2025-04-05', submitDate: '2025-03-18' },
  { id: 8, rfiNumber: 'RFI-008', title: 'Fire rated wall assembly at stairwell 3', from: 'Turner Construction', to: 'Morris Architects', priority: 'high', status: 'pending', dueDate: '2025-03-30', submitDate: '2025-03-20' },
  { id: 9, rfiNumber: 'RFI-009', title: 'Parking garage exhaust fan location', from: 'HVAC Subcontractor', to: 'MEP Consultant', priority: 'low', status: 'approved', dueDate: '2025-04-10', submitDate: '2025-03-15' },
  { id: 10, rfiNumber: 'RFI-010', title: 'Lobby ceiling height confirmation at entry canopy', from: 'Turner Construction', to: 'Morris Architects', priority: 'medium', status: 'pending', dueDate: '2025-04-01', submitDate: '2025-03-23' },
  { id: 11, rfiNumber: 'RFI-011', title: 'Mechanical room access door swing direction', from: 'HVAC Subcontractor', to: 'Morris Architects', priority: 'low', status: 'approved', dueDate: '2025-04-08', submitDate: '2025-03-12' },
  { id: 12, rfiNumber: 'RFI-012', title: 'Concrete mix design for Level 10 slab pour', from: 'Turner Construction', to: 'Structural Engineer', priority: 'critical', status: 'pending', dueDate: '2025-03-29', submitDate: '2025-03-24' },
  { id: 13, rfiNumber: 'RFI-013', title: 'Switchgear room ventilation requirements', from: 'Electrical Contractor', to: 'MEP Consultant', priority: 'medium', status: 'pending', dueDate: '2025-04-04', submitDate: '2025-03-21' },
  { id: 14, rfiNumber: 'RFI-014', title: 'Exterior stone cladding joint sealant specification', from: 'Steel Erector', to: 'Morris Architects', priority: 'high', status: 'approved', dueDate: '2025-04-03', submitDate: '2025-03-16' },
  { id: 15, rfiNumber: 'RFI-015', title: 'Retail tenant demising wall construction type', from: 'Turner Construction', to: 'Morris Architects', priority: 'medium', status: 'pending', dueDate: '2025-04-06', submitDate: '2025-03-25' },
];
...
const mockTimeline = [
  {
    initials: 'TC',
    name: 'Tom Chen',
    role: 'Project Manager, Turner Construction',
    date: 'Mar 21, 2025 at 9:15 AM',
    message: 'Submitted RFI for review. Please advise on the specification details referenced in drawing set A3.2. We need clarification before proceeding with field installation.',
    type: 'submitted' as const,
  },
  {
    initials: 'MA',
    name: 'Maria Alvarez',
    role: 'Architect, Morris Architects',
    date: 'Mar 22, 2025 at 2:30 PM',
    message: 'Reviewed the referenced drawings. We will need to coordinate with the structural engineer on this item. Forwarding to their team for input.',
  ...
  },
  {
    ...
    date: 'Mar 23, 2025 at 10:45 AM',
    message: 'Confirmed the connection detail is acceptable as shown in RFI sketch. Recommend using the alternate anchor bolt pattern per specification section 05 12 00.',
    ...
    <PageContainer
      ...
      actions={
        <div style={{ display: 'flex', alignItems: 'center', gap: spacing['3'] }}>
          ...
          <Btn onClick={() => addToast('info', 'New RFI form coming soon')}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 0 }}>
                {mockTimeline.map((entry, idx) => (
                  <div key={idx} style={{ display: 'flex', gap: spacing.md, position: 'relative' }}>
                    ...
                    {/* Content */}
                    <div style={{ flex: 1, paddingBottom: idx < mockTimeline.length - 1 ? spacing.xl : '0' }}>
