          ...
          <PermissionGate permission="rfis.create">
            <button
              ...
              style={{
                ...
                padding: '7px 14px', minHeight: 44, border: 'none', borderRadius: borderRadius.md,
