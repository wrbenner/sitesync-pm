    ...
    <div style={{ flex: 1, minWidth: 0 }}>
      ...
      <div
        style={{
          ...
          color: overBudget ? colors.statusCritical : muted ? colors.ink3 : colors.ink,
        }}
      >
        {value}
      </div>
      ...
      >
        ...
        >
          ...
          >
            ...
            />
            <BigNumber
              label={budgetRemaining < 0 ? 'Over by' : 'Remaining'}
              value={budgetTotal ? formatCurrency(Math.abs(budgetRemaining)) : '—'}
