        ...
        {currentStatus !== 'void' && (
          <div style={{
            ...
            <WorkflowTimeline
              ...
              completedStates={RFI_WORKFLOW_STATES.slice(
                0,
                RFI_WORKFLOW_STATES.indexOf(currentStatus)
              )}
