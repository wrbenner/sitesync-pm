...
const SiteIntelligencePage: React.FC = () => {
  ...
  const handleSearch = useCallback(async (address?: string) => {
    ...
    setError(null);
    setShowSuggestions(false);
    // eslint-disable-next-line react-hooks/todo -- React Compiler todo: try/finally support pending
    try {
  ...
  useEffect(() => {
    ...
    (async () => {
      // eslint-disable-next-line react-hooks/todo -- React Compiler todo: dynamic import not yet supported
