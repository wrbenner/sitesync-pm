...
const TimeTracking: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Tab Navigation — scrollable with right-fade hint on narrow viewports */}
      <div style={{ position: 'relative', marginBottom: spacing['4'] }}>
        <div style={{ display: 'flex', gap: spacing['1'], borderBottom: `1px solid ${colors.borderSubtle}`, paddingBottom: spacing['1'], overflowX: 'auto', scrollbarWidth: 'none' }}>
          {([
        ...
        <div aria-hidden="true" style={{ position: 'absolute', top: 0, right: 0, bottom: 0, width: 56, background: `linear-gradient(to right, transparent, ${colors.surfacePage})`, pointerEvents: 'none' }} />
      </div>
