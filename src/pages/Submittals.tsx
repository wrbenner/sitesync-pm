...
const extraSubmittals = [
  { id: 5, submittalNumber: 'SUB-005', title: 'Concrete Mix Design for Structural Elements', from: 'Turner Construction', priority: 'high', status: 'approved', dueDate: '2025-03-20' },
  { id: 6, submittalNumber: 'SUB-006', title: 'Curtain Wall System Shop Drawings', from: 'Exterior Subcontractor', priority: 'critical', status: 'under_review', dueDate: '2025-04-01' },
  { id: 7, submittalNumber: 'SUB-007', title: 'HVAC Equipment Submittals', from: 'Quality HVAC Services', priority: 'high', status: 'pending', dueDate: '2025-04-05' },
  { id: 8, submittalNumber: 'SUB-008', title: 'Elevator Cab Finishes and Materials', from: 'Elevator Contractor', priority: 'medium', status: 'pending', dueDate: '2025-04-10' },
  { id: 9, submittalNumber: 'SUB-009', title: 'Fire Sprinkler Layout and Calculations', from: 'Fire Protection Sub', priority: 'high', status: 'approved', dueDate: '2025-03-22' },
  { id: 10, submittalNumber: 'SUB-010', title: 'Electrical Switchgear Specifications', from: 'Electrical Supplier', priority: 'critical', status: 'under_review', dueDate: '2025-03-30' },
  { id: 11, submittalNumber: 'SUB-011', title: 'Plumbing Fixtures and Trim', from: 'Plumbing Contractor', priority: 'medium', status: 'approved', dueDate: '2025-03-25' },
  { id: 12, submittalNumber: 'SUB-012', title: 'Waterproofing Membrane System', from: 'Waterproofing Sub', priority: 'high', status: 'revise_resubmit', dueDate: '2025-04-02' },
  { id: 13, submittalNumber: 'SUB-013', title: 'Acoustic Ceiling Tile Selections', from: 'Interior Subcontractor', priority: 'low', status: 'approved', dueDate: '2025-04-08' },
  { id: 14, submittalNumber: 'SUB-014', title: 'Door Hardware Schedule (Resubmission)', from: 'Hardware Supplier', priority: 'medium', status: 'pending', dueDate: '2025-04-04' },
  { id: 15, submittalNumber: 'SUB-015', title: 'Paint Color Selections and Samples', from: 'Paint Contractor', priority: 'low', status: 'approved', dueDate: '2025-04-12' },
  { id: 16, submittalNumber: 'SUB-016', title: 'Structural Steel Connection Details (Rev 2)', from: 'Fabricator ABC Steel', priority: 'critical', status: 'revise_resubmit', dueDate: '2025-03-28' },
];
...
const Submittals: React.FC = () => {
  ...
  const allSubmittals = [...submittals, ...extraSubmittals];
    ...
    <PageContainer
      ...
      actions={
        <div style={{ display: 'flex', alignItems: 'center', gap: spacing.sm }}>
          ...
          <Btn onClick={() => addToast('info', 'New submittal form coming soon')}>New Submittal</Btn>
        </div>
      }
    >
