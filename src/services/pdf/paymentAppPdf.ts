...
,
  ...
  await drawText(
    page,
    'AIA Document G702 - Application and Certificate for Payment. Generated by SiteSync PM.',
    LEFT,
    footerY,
    fontReg,
    7,
...
export async function generatePayAppPdfFromData(data: PayAppPdfData): Promise<Blob> {
  ...
  if (sovLines.length > 0) {
    ...
    for (let pi = 0; pi < totalPages; pi++) {
      ...
      const fY = MG - 10
      await drawText(pg, 'AIA Document G703 - Continuation Sheet. Generated by SiteSync PM.', MG, fY, fontReg, 7, TW)
    }
  }
...
export async function generateG702Pdf(params: G702Params): Promise<Uint8Array> {
  ...
  await drawText(
    page,
    'AIA Document G702. Application Number ' + params.applicationNumber + '. Generated by SiteSync PM.',
    L, footerY, fontReg, 7, W,
  )
...
export async function generateG703Pdf(params: G703Params): Promise<Uint8Array> {
  ...
  for (let pi = 0; pi < totalPages; pi++) {
    ...
    await drawText(
      pg,
      'AIA Document G703 - Continuation Sheet. Application No ' + applicationNumber + '. Generated by SiteSync PM.',
