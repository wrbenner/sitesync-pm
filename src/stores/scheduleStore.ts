...
function mapToMappedPhase(d: Record<string, unknown>): MappedSchedulePhase {
  ...
  return {
    ...
    is_milestone: (d['is_milestone'] as boolean | null) ?? ((d['is_critical_path'] as boolean | null) ?? null),
    predecessor_ids: (d['predecessor_ids'] as string[] | null) ?? null,
    work_type: null,
    location: null,
    assigned_trade: null,
    ...
    isMilestone: (d['is_milestone'] as boolean | null) ?? ((d['is_critical_path'] as boolean | null) ?? false),
