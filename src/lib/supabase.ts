...
// throw and Supabase calls fail gracefully instead of crashing the module.
...
const supabaseUrl = rawUrl || (isAcceptanceBuild || isDevBypassBuild ? 'http://dev-bypass.invalid' : '')
const supabaseAnonKey = rawKey || (isAcceptanceBuild || isDevBypassBuild ? 'dev-bypass-stub-key' : '')
