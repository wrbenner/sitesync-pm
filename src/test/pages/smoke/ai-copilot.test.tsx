...
describe('AI Copilot smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/AICopilot')
    const Page = (mod as Record<string, unknown>).AICopilot ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/copilot' }))
      .not.toThrow()
  })
})
