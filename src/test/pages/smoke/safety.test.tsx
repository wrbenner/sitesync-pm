...
describe('Safety smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/safety/index')
    const Page = (mod as Record<string, unknown>).Safety ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/safety' }))
      .not.toThrow()
  })
})
