...
describe('Dashboard (root) smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/dashboard/index')
    const Page = (mod as Record<string, unknown>).Dashboard ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/' }))
      .not.toThrow()
  })
})
