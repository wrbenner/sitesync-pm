...
describe('Vendors smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Vendors')
    const Page = (mod as Record<string, unknown>).Vendors ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/vendors' }))
      .not.toThrow()
  })
})
