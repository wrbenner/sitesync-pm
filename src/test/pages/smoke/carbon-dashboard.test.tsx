...
describe('Carbon Dashboard smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/CarbonDashboard')
    const Page = (mod as Record<string, unknown>).CarbonDashboard ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/carbon' }))
      .not.toThrow()
  })
})
