...
describe('Specifications smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Specifications')
    const Page = (mod as Record<string, unknown>).Specifications ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/specifications' }))
      .not.toThrow()
  })
})
