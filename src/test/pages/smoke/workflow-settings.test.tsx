...
describe('Workflow Settings smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Settings/WorkflowSettings')
    const Page = (mod as Record<string, unknown>).WorkflowSettings ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/settings/workflows' }))
      .not.toThrow()
  })
})
