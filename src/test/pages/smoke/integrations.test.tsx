...
describe('Integrations smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Integrations')
    const Page = (mod as Record<string, unknown>).Integrations ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/integrations' }))
      .not.toThrow()
  })
})
