...
describe('Procurement smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Procurement')
    const Page = (mod as Record<string, unknown>).Procurement ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/procurement' }))
      .not.toThrow()
  })
})
