...
describe('Cost Management smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/CostManagement')
    const Page = (mod as Record<string, unknown>).CostManagement ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/cost-management' }))
      .not.toThrow()
  })
})
