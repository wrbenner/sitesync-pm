...
describe('Directory smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Directory')
    const Page = (mod as Record<string, unknown>).Directory ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/directory' }))
      .not.toThrow()
  })
})
