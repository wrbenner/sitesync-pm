...
describe('Lookahead smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Lookahead')
    const Page = (mod as Record<string, unknown>).Lookahead ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/lookahead' }))
      .not.toThrow()
  })
})
