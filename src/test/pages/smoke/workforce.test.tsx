...
describe('Workforce smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Workforce')
    const Page = (mod as Record<string, unknown>).Workforce ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/workforce' }))
      .not.toThrow()
  })
})
