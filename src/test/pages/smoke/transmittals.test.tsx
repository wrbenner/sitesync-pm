...
describe('Transmittals smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Transmittals')
    const Page = (mod as Record<string, unknown>).Transmittals ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/transmittals' }))
      .not.toThrow()
  })
})
