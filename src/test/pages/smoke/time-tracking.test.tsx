...
describe('Time Tracking smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/TimeTracking')
    const Page = (mod as Record<string, unknown>).TimeTracking ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/time-tracking' }))
      .not.toThrow()
  })
})
