...
describe('Audit Trail smoke', () => {
  it('renders without throwing', async () => {
    ...
    const Page = (mod as Record<string, unknown>).AuditTrail ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/audit-trail' }))
      .not.toThrow()
  })
})
