...
describe('Resources smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Resources')
    const Page = (mod as Record<string, unknown>).Resources ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/resources' }))
      .not.toThrow()
  })
})
