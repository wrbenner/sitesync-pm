...
describe('Deliveries smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Deliveries')
    const Page = (mod as Record<string, unknown>).Deliveries ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/deliveries' }))
      .not.toThrow()
  })
})
