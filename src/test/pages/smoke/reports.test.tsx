...
describe('Reports smoke', () => {
  it('renders without throwing', async () => {
    ...
    const Page = (mod as Record<string, unknown>).Reports ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/reports' }))
      .not.toThrow()
  })
})
