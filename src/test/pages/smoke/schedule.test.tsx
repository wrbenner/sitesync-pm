...
describe('Schedule smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/schedule/index')
    const Page = (mod as Record<string, unknown>).Schedule ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/schedule' }))
      .not.toThrow()
  })
})
