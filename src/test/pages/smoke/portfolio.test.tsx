...
describe('Portfolio smoke', () => {
  it('renders without throwing', async () => {
    ...
    const Page = (mod as Record<string, unknown>).Portfolio ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/portfolio' }))
      .not.toThrow()
  })
})
