...
describe('Owner Report smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/OwnerReportPage')
    const Page = (mod as Record<string, unknown>).OwnerReportPage ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/reports/owner' }))
      .not.toThrow()
  })
})
