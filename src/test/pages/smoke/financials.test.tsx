...
describe('Financials smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Financials')
    const Page = (mod as Record<string, unknown>).Financials ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/financials' }))
      .not.toThrow()
  })
})
