...
describe('Field Capture smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/field-capture/index')
    const Page = (mod as Record<string, unknown>).FieldCapture ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/field-capture' }))
      .not.toThrow()
  })
})
