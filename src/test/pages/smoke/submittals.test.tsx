...
describe('Submittals smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/submittals/index')
    const Page = (mod as Record<string, unknown>).Submittals ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/submittals' }))
      .not.toThrow()
  })
})
