...
describe('Closeout smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Closeout')
    const Page = (mod as Record<string, unknown>).Closeout ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/closeout' }))
      .not.toThrow()
  })
})
