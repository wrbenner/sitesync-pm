...
describe('Project Health smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/ProjectHealth')
    const Page = (mod as Record<string, unknown>).ProjectHealth ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/project-health' }))
      .not.toThrow()
  })
})
