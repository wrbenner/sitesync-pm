...
describe('Contracts smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Contracts')
    const Page = (mod as Record<string, unknown>).Contracts ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/contracts' }))
      .not.toThrow()
  })
})
