...
describe('Owner Portal smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/OwnerPortal')
    const Page = (mod as Record<string, unknown>).OwnerPortal ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/portal/owner' }))
      .not.toThrow()
  })
})
