...
describe('Meetings smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Meetings')
    const Page = (mod as Record<string, unknown>).Meetings ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/meetings' }))
      .not.toThrow()
  })
})
