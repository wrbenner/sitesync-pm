...
describe('AI Agents smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/AIAgents')
    const Page = (mod as Record<string, unknown>).AIAgents ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/ai-agents' }))
      .not.toThrow()
  })
})
