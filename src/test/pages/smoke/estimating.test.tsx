...
describe('Estimating smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Estimating')
    const Page = (mod as Record<string, unknown>).Estimating ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/estimating' }))
      .not.toThrow()
  })
})
