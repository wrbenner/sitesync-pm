...
describe('Lien Waivers smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/LienWaivers')
    const Page = (mod as Record<string, unknown>).LienWaivers ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/lien-waivers' }))
      .not.toThrow()
  })
})
