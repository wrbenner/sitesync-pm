...
describe('Change Orders smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/ChangeOrders')
    const Page = (mod as Record<string, unknown>).ChangeOrders ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/change-orders' }))
      .not.toThrow()
  })
})
