...
describe('Preconstruction smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Preconstruction')
    const Page = (mod as Record<string, unknown>).Preconstruction ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/preconstruction' }))
      .not.toThrow()
  })
})
