...
describe('Pay Applications smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/payment-applications/index')
    const Page = (mod as Record<string, unknown>).PaymentApplications ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/pay-apps' }))
      .not.toThrow()
  })
})
