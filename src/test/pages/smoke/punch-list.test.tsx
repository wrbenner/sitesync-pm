...
describe('Punch List smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/punch-list/index')
    const Page = (mod as Record<string, unknown>).PunchList ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/punch-list' }))
      .not.toThrow()
  })
})
