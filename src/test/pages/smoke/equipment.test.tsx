...
describe('Equipment smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/Equipment')
    const Page = (mod as Record<string, unknown>).Equipment ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/equipment' }))
      .not.toThrow()
  })
})
