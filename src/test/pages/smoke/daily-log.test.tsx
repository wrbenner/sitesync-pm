...
describe('Daily Log smoke', () => {
  it('renders without throwing', async () => {
    const mod = await import('../../../pages/daily-log/index')
    const Page = (mod as Record<string, unknown>).DailyLog ?? (mod as { default?: unknown }).default
    expect(typeof Page).toBe('function')
    expect(() => renderPageWithProviders(React.createElement(Page as React.ComponentType), { route: '/daily-log' }))
      .not.toThrow()
  })
})
