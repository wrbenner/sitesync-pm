...
export type SubmittalApproval = TableRow<'submittal_approvals'>
export type SubmittalReviewer = TableRow<'submittal_approvals'>
export type SubmittalStatus = 'draft' | 'submitted' | 'gc_review' | 'architect_review' | 'approved' | 'rejected' | 'resubmit' | 'closed'
