...
// Some tables we write to (pay_application_line_items, freshly added columns
// on pay_applications, etc.) aren't in the generated Database types yet.
// Use the fromTable helper which accepts extended table names.
