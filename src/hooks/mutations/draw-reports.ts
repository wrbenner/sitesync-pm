...
// Escape hatch for tables not yet in generated Database types.
// Cast the table name to the union of known table names so the query builder
// accepts .eq() filters on columns PostgREST validates server-side.
