...
export function useMfa(): MfaState {
  ...
  // TanStack Query is queued as a Phase 2 cleanup.
  useEffect(() => {
    // eslint-disable-next-line react-hooks/set-state-in-effect -- refresh is async; setState after network response, not synchronously
    void refresh()
  }, [refresh])
