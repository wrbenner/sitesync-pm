...
export function useCreateEstimate() {
  ...
  return useMutation({
    ...
    onSuccess: (_d, vars) => {
      qc.invalidateQueries({ queryKey: ['estimates', (vars as Record<string, unknown>)['project_id']] })
    },
  })
}
...
export function useCreateEstimateLineItem() {
  ...
  return useMutation({
    ...
    onSuccess: (_d, vars) => {
      qc.invalidateQueries({ queryKey: ['estimate_line_items', (vars as Record<string, unknown>)['estimate_id']] })
    },
  })
}
