...
type RawSearchRow = { id: string; name?: string; title?: string; description?: string | null; discipline?: string | null; project_id: string; created_at: string }
