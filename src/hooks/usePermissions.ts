...
export type Permission =
  ...
  | 'rfis.view' | 'rfis.create' | 'rfis.edit' | 'rfis.respond'
  | 'submittals.view' | 'submittals.create' | 'submittals.edit' | 'submittals.approve'
  | 'budget.view' | 'budget.edit' | 'budget.approve'
  | 'change_orders.view' | 'change_orders.create' | 'change_orders.approve'
  | 'schedule.view' | 'schedule.edit'
  | 'daily_log.view' | 'daily_log.create' | 'daily_log.approve'
  | 'punch_list.view' | 'punch_list.create' | 'punch_list.edit'
