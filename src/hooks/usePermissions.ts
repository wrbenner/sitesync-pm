...
export type Permission =
  ...
  | 'pay_apps.view' | 'pay_apps.create' | 'pay_apps.approve'
...
export const PERMISSION_MATRIX: Record<Permission, ProjectRole[]> = {
  ...
  'rfis.create': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  ...
  'pay_apps.view': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  'pay_apps.create': ['owner', 'admin', 'project_manager', 'subcontractor'],
  'pay_apps.approve': ['owner', 'admin', 'project_manager'],
  ...
  'daily_log.view': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor', 'viewer'],
  'daily_log.create': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  'daily_log.edit': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  'daily_log.submit': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  ...
  'punch_list.create': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  'punch_list.edit': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
  ...
  'field_capture.view': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor', 'viewer'],
  'field_capture.create': ['owner', 'admin', 'project_manager', 'superintendent', 'subcontractor'],
