...
function AppContent() {
  ...
  const location = useLocation();
  // Tablets (≤1024px, i.e. iPad portrait) use MobileLayout — bottom-tab shell,
  // full viewport width, no sidebar. Desktop grid (sidebar + main) only at 1025px+.
  // At 1024px the sidebar overlapped page content (sticky z-index 1020 over the
  // grid column), and 772px of content width is too narrow for most pages at that size.
