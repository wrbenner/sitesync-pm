...
// BRT sub-6 §4.2 — in-app help center
...
function usePrefetchRoutes(isAuthenticated: boolean) {
  useEffect(() => {
    ...
    const prefetch = () => {
      // Dynamic-import prefetch for the high-traffic routes. The React
      // Compiler can't statically lower bare import() inside a function;
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Routes location={location}>
            ...
            {/* BRT sub-6 §4.2 — help center (public; deep-linkable from "?" icons) */}
            <Route path="/help" element={<PageSuspense><HelpIndex /></PageSuspense>} />
            <Route path="/help/:articleId" element={<PageSuspense><HelpArticle /></PageSuspense>} />
