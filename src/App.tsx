...
function AppContent() {
  ...
  // dense table pages and the sticky sidebar (z-index:sticky) visually overlaps content
  // in the CSS grid. Desktop sidebar layout only engages above 1024px.
  ...
  useEffect(() => {
    // Mobile/tablet (≤1024px) uses MobileLayout — collapse the sidebar so any
    // brief flash through the desktop tree doesn't widen the layout.
    if (isMobile) {
