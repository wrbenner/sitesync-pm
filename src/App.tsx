...
// BRT sub-2 §4.1 + §4.2 — verification + OAuth callback pages
...
function usePrefetchRoutes(isAuthenticated: boolean) {
  useEffect(() => {
    ...
    const prefetch = () => {
      ...
      // can't statically lower bare import() inside a function; intentional.
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Routes location={location}>
            ...
            {/* BRT sub-2 §4.1 + §4.2 — verification + OAuth callback */}
            <Route path="/auth/verify-pending" element={<PageSuspense><VerifyPending /></PageSuspense>} />
            <Route path="/auth/verify-success" element={<PageSuspense><VerifySuccess /></PageSuspense>} />
...
function AppContent() {
  ...
  // instead of a separate setState-in-effect.
