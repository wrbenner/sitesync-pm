...
// BRT sub-4 §4.5 — self-serve billing settings page
      ...
      <AnimatePresence mode="wait">
        ...
        >
          <Routes location={location}>
            ...
            {/* BRT sub-4 §4.5 — self-serve billing */}
            <Route path="/settings/billing" element={<PageSuspense><BillingSettings /></PageSuspense>} />
