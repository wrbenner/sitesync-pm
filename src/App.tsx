...
function AppContent() {
  ...
  useEffect(() => {
    ...
    // Tablet (769–1024px) shows the 72px icon rail: force collapsed=true so
    // the grid allocates 72px (not 252px) and saves the desktop preference so
    // it can be restored when the viewport grows back to desktop.
    if (isMobile) {
