...
import { Cloud, Sun, CloudRain, CloudSnow, Users, ShieldCheck, AlertTriangle, Camera, Clock, Check, RefreshCw, Loader2, Send, X, FileText, Wrench, Truck, HardHat, Mic } from 'lucide-react';
