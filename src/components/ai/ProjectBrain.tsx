...
import { Brain, X, Send, FileText, Loader2, Sparkles, Database, ChevronRight, MessageSquare, Scale, FolderOpen, History, Plus, Trash2, AlertTriangle, CheckCircle, Shield, Clock, ArrowRight, Search, Eye, BarChart3, Zap, BookOpen, HardHat, FileCheck } from 'lucide-react';
