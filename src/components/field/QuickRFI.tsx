  ...
  const handleVoiceDone = useCallback(async () => {
    ...
    try {
      ...
      const fallbackDraft: AIDraft = {
        ...
        question: transcript || 'Photo captured. Add a description before submitting.',
      ...
      setError('AI processing failed. Showing captured data. Edit and submit when ready.');
      setPhase('review');
    }
  ...
  const handleSkipVoice = useCallback(async () => {
    ...
    try {
      ...
      const fallback: AIDraft = {
        subject: 'Field Observation',
        question: 'Photo captured. Add a description before submitting.',
        trade_classification: { urgency: 'medium' },
      };
      setAiDraft(fallback);
      setEditSubject(fallback.subject);
      setEditQuestion(fallback.question);
      setError('AI processing failed. Edit and submit manually.');
      setPhase('review');
    }
