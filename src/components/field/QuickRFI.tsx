  ...
  const handleVoiceDone = useCallback(async () => {
    ...
    try {
      ...
      const fallbackDraft: AIDraft = {
        ...
        question: transcript || 'Photo captured. Add a description.',
      ...
      setError('AI processing failed. Captured data shown below. Edit and submit to continue.');
      setPhase('review');
    }
  ...
  const handleSkipVoice = useCallback(async () => {
    ...
    try {
      ...
      const fallback: AIDraft = {
        subject: 'Field Observation',
        question: 'Photo captured. Add a description.',
        trade_classification: { urgency: 'medium' },
      };
      setAiDraft(fallback);
