    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: spacing['1'] }}>
      {messages.length === 0 && (
        <div style={{
          ...
          padding: `${spacing['8']} ${spacing['4']}`, gap: spacing['2'],
          color: colors.textTertiary, textAlign: 'center',
        }}>
          <span style={{ fontSize: typography.fontSize.sm }}>No messages yet. Be the first to comment.</span>
        </div>
      )}
      {messages.map((msg, i) => {
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: spacing['1'], marginTop: spacing['2'], flexWrap: 'wrap' }}>
                    ...
                    >
                      {QUICK_EMOJIS.map((emoji) => (
                        <button
                          ...
                          style={{
                            minWidth: touchTarget.field, height: touchTarget.field,
                            display: 'flex', alignItems: 'center', justifyContent: 'center',
                            border: 'none', borderRadius: borderRadius.sm, backgroundColor: 'transparent',
                            cursor: 'pointer', fontSize: 20, fontFamily: typography.fontFamily,
                ...
                <button
                  ...
                  aria-label={replyToId === msg.id ? 'Cancel reply' : `Reply to ${msg.name}`}
                  style={{
              ...
              {pendingAttachmentUrls.map((url) => (
                <div key={url} style={{
                  ...
                  <button
                    ...
                    aria-label={`Remove attachment ${fileNameFromUrl(url)}`}
                    style={{
                      border: 'none', backgroundColor: 'transparent', cursor: 'pointer',
                      color: colors.textTertiary, display: 'flex', alignItems: 'center', justifyContent: 'center',
                      minWidth: touchTarget.field, minHeight: touchTarget.field,
