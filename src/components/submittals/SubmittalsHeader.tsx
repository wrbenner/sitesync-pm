// Phase 1 — slim page header. Replaces the old oversized "Submittals" title +
// 4-card KPI strip with a tight title row, settings gear, and the inline
// four-count strip below.
//
...
export interface SubmittalsHeaderProps {
  ...
  /** Click → /submittals/settings (Phase 8 placeholder). */
  onOpenSettings?: () => void
}
...
export const SubmittalsHeader: React.FC<SubmittalsHeaderProps> = ({
  ...
  >
    ...
    {/* Slim inline strip — replaces the 4 KPI cards from the old shell.
        Drops the 240d-bug "Avg Review Time" card per visual audit §H. */}
    <div
      role="status"
