...
export const PAGE_REGISTRY: PageContract[] = [
  ...
  },
  {
    ...
    pageFile: 'src/pages/Settings/security/ImpersonationHistory.tsx',
    title: 'SiteSync Staff Access History',
    entity: null,
  ...
  {
    route: '/admin/orgs',
    pageFile: 'src/pages/admin/AdminOrgList.tsx',
    title: 'Admin — Organizations',
    entity: null,
    expected: { has_list: true, has_search: true },
    status: 'production',
  },
  {
    route: '/admin/orgs/:id',
    pageFile: 'src/pages/admin/AdminOrgDetail.tsx',
  ...
  },
  {
    ...
    pageFile: 'src/pages/admin/ImpersonationLog.tsx',
    title: 'Admin — Impersonation Audit Log',
    entity: null,
    expected: { has_list: true },
    status: 'production',
  },
  {
    route: '/help',
    pageFile: 'src/pages/help/HelpIndex.tsx',
    title: 'Help Center',
    entity: null,
    expected: { has_list: true, has_search: true },
    status: 'production',
  ...
  {
    route: '/help/:slug',
    pageFile: 'src/pages/help/HelpArticle.tsx',
    title: 'Help Article',
    entity: null,
    expected: { has_detail_view: true },
    status: 'production',
  ...
  {
    route: '/rfis/settings',
    pageFile: 'src/pages/rfis/RFISettingsPage.tsx',
    title: 'RFI Settings',
    entity: 'rfi',
    expected: {
      has_list: true,
    ...
    hooksModule: 'src/hooks/queries/useRFISettings.ts',
    permissionModule: 'rfis',
    status: 'production',
  },
  {
    route: '/rfis/reports',
    pageFile: 'src/pages/rfis/RFIReportsPage.tsx',
    title: 'RFI Reports',
    entity: 'rfi',
    expected: {
      has_list: true,
    ...
    hooksModule: 'src/lib/rfi/reports.ts',
    permissionModule: 'rfis',
    status: 'production',
  },
  {
  ...
  // ── Contracts / Permits / Transmittals / Closeout ────────
  {
    ...
    hooksModule: 'src/hooks/queries/permits.ts',
  ...
  },
  {
    ...
    hooksModule: 'src/hooks/queries/enterprise-modules.ts',
  ...
  // ── Financial ops / Reports ──────────────────────────────
  {
    ...
    createModal: 'CreateEditPayAppDrawer',
    hooksModule: 'src/hooks/queries/financials.ts',
...
> = {
  ...
  drawing: {},
  'pay-app': { create: 'useCreatePayApplication', update: 'useUpdatePayApplication', delete: 'useDeletePayApplication', module: 'src/hooks/queries/financials.ts' },
  permit: { create: 'useCreatePermit', update: 'useUpdatePermit', delete: 'useDeletePermit', module: 'src/hooks/queries/permits.ts' },
  contract: { create: 'useCreateContract', update: 'useUpdateContract', delete: 'useDeleteContract', module: 'src/hooks/queries/enterprise-modules.ts' },
